...
export function CTABanner() {
  return (
    <section className="py-20 md:py-28 bg-white dark:bg-[#0d0d0d]">
      <div className="container mx-auto px-4 md:px-8 lg:px-16">
        <div className="relative rounded-3xl border border-[#00c8ff]/10 bg-[#f9f9f9] dark:bg-[#161616] overflow-hidden px-8 md:px-14 py-14 md:py-20 text-center">
          {/* Background glow */}
          ...
          <div className="relative z-10 flex flex-col items-center gap-6 max-w-2xl mx-auto">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-extralight tracking-wide uppercase text-gray-900 dark:text-white leading-tight">
              Find Out What Your Manual Processes
              <br />
              <span className="text-[#00c8ff]">Are Costing You.</span>
            </h2>

            <p className="text-sm text-gray-400 dark:text-white/40 leading-relaxed max-w-lg">
