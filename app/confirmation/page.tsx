      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 py-16 md:py-24">
        <div className="w-full max-w-xl text-center flex flex-col items-center gap-8">
          ...
          <div className="flex flex-col gap-3">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-extralight tracking-wide uppercase text-gray-900 dark:text-white">
              You&#39;re All Set.
            </h1>
          ...
          <div className="w-full flex flex-col gap-4 text-left mt-2">
            <div className="flex items-start gap-4 bg-white dark:bg-[#161616] border border-gray-200 dark:border-white/5 rounded-2xl px-5 py-4">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
            ...
            <Link href="/" className="w-full sm:w-auto">
              <Button
                variant="ghost"
                className="w-full text-gray-400 dark:text-white/40 hover:text-gray-900 dark:hover:text-white border border-gray-200 dark:border-white/10 hover:border-gray-400 dark:hover:border-white/30 tracking-widest text-xs uppercase rounded-full px-8 h-12 touch-manipulation"
              >
                Back to Home
              </Button>
            </Link>
